...
/*
	JavaScript Polyfills and extension.
...
Object.defineProperty(Math, 'ranint', {
	configurable : true,
	writable     : true,
...
Object.defineProperty(Array.prototype, 'randPop', {
	...
	value() {
		if (this == null) {
			throw new TypeError('Array.prototype.randPop called on null or undefined');
		}
...
Object.defineProperty(Array.prototype, 'draw', {
	...
	value(/* DEPRECATED: [min ,] max */) {
		if (this == null) {
			// lazy equality for null
			throw new TypeError('Array.prototype.draw called on null or undefined');
		}
...
*/
Object.defineProperty(Array.prototype, 'drawMany', {
	configurable: true,
	writable: true,
	...
	value(wantSize) {
		if (this == null) {
			// lazy equality for null
			throw new TypeError('Array.prototype.drawMany called on null or undefined');
		}
