...
var UIBar = (() => { // eslint-disable-line no-unused-vars, no-var
	...
	*******************************************************************************/
	function resetUI() {
		$("#story-header").removeClass("bar-stowed").removeClass("bar-extend");
		$("#story-footer").removeClass("bar-stowed").removeClass("bar-extend");
		$("#story").removeClass("bar-stowed").removeClass("bar-extend");
	
		if (_$uiBar.hasClass("stowed")) {
		  $("#story-header").addClass("bar-stowed");
		  $("#story-footer").addClass("bar-stowed");
		  $("#story").addClass("bar-stowed");
		} else {
		  $("#story-header").addClass("bar-extend");
		  $("#story-footer").addClass("bar-extend");
		  $("#story").addClass("bar-extend");
		}
	  }
